...
RAW_DATA_ROOT = '../../raw_data/directed_graphs/'
...
def dump_seeding_data_file(n, p_M, b_p, k, graph_index):
...
def run_script(n, b_p, n_jobs):
    param_collection = [(graph_index, p_M)
    ...
    parallel(
        ...
        for (graph_index, p_M) in param_collection
    )
